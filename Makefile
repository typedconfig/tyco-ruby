...
cppflags = 
CCDLFLAGS = -fPIC
CFLAGS   = $(CCDLFLAGS) -O2 -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-U_FORTIFY_SOURCE,-D_FORTIFY_SOURCE=3 -Wp,-D_GLIBCXX_ASSERTIONS -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -fstack-protector-strong -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -march=x86-64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection -mtls-dialect=gnu2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -fPIC $(ARCH_FLAG)
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir)
DEFS     = 
CPPFLAGS =  -I/home/mlauria/typedconfig/tyco-c/include  $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) -O2 -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-U_FORTIFY_SOURCE,-D_FORTIFY_SOURCE=3 -Wp,-D_GLIBCXX_ASSERTIONS -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -fstack-protector-strong -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -march=x86-64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection -mtls-dialect=gnu2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer   $(ARCH_FLAG)
...
dldflags = -Wl,-z,relro -Wl,--as-needed  -Wl,-z,pack-relative-relocs -Wl,-z,now -specs=/usr/lib/rpm/redhat/redhat-hardened-ld -specs=/usr/lib/rpm/redhat/redhat-hardened-ld-errors -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  -Wl,--build-id=sha1    
ARCH_FLAG = -m64
...
preload = 
libpath = . $(archlibdir) /home/mlauria/typedconfig/tyco-c/build
LIBPATH = -L. -L$(archlibdir) -L/home/mlauria/typedconfig/tyco-c/build
DEFFILE = 
...
extout = 
extout_prefix = 
target_prefix = /tyco_ext
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -ltyco_c  -lm -lpthread  -lc
ORIG_SRCS = tyco_ext.c
SRCS = $(ORIG_SRCS) 
OBJS = tyco_ext.o
HDRS = 
LOCAL_HDRS = 
TARGET = tyco_ext
TARGET_NAME = tyco_ext
...
CLEANOBJS     = $(OBJS) *.bak
TARGET_SO_DIR_TIMESTAMP = $(TIMESTAMP_DIR)/.sitearchdir.-.tyco_ext.time
...
$(TARGET_SO): $(OBJS) Makefile
	$(ECHO) linking shared-object tyco_ext/$(DLLIB)
	-$(Q)$(RM) $(@)
